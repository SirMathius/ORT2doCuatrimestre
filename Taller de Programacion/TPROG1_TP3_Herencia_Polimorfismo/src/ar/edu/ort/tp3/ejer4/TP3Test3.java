...
public class TP3Test3 {
	...
	public static void main(String[] args) {
		...
		// Crear un programa que permita cargar una lista de artículos y luego ofrecer
		// al usuario esos productos. Solo se
		...
		// creo cliente
		Cliente pepe = new Cliente("20350846264");

		// Una vez que el usuario elija, se deberá mostrar del
		// detalle completo y solicitarle al usuario que confirme la selección.
		// Continuar ofreciéndole artículos hasta que
		// el usuario elija la opción “0”. En ese momento se deberá imprimir el ticket
		// completo con la infromacion de
		// todos los artículos elegidos y el importe total de la venta.
		
		//crear ticket
		
		Ticket t = new Ticket(pepe, ejemplo);
